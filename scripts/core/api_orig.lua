...
function luaLFS:sta(imsg)
	...
	return { replayspeed = replayspeed, flags = flags, ingamecam = ingamecam, viewplid = viewplid, nump = nump, numconns = numconns, numfinished = numfinished, raceinprog = raceinprog, qualmins = qualmins, racelaps = racelaps, track = track, weather = weather, wind = wind }
end
